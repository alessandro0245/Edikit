...
export default function PromptPage() {
  ...
  // Auto-scroll to prompt on reset
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col lg:flex-row">
            ...
            <div className="space-y-6">
              ...
              {(isComplete || isError) && (
                <button
                  ...
                  title="Start a new video generation"
                >
                  {isError ? (
                    <>
              ...
              {/* Download button below Create Another Video, only if video is ready */}
              {isComplete && outputUrl && (
                <VideoDownloadButton
                  ...
                  tooltip={
                    downloadError
                      ? "Link expired or failed. Please refresh."
                      : "Download your video"
                  }
      ...
      <main className="flex-1 flex flex-col items-center justify-start p-6 lg:p-14 gap-6 min-h-[90vh] lg:min-h-screen">
        ...
        {/* No action buttons below video for minimal look */}
