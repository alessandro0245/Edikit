            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="order-1 lg:order-2 space-y-6 px-3">
                <div className="space-y-4">
                  ...
                  Design professional motion graphics with stunning pre-designed templates or generate videos instantly using AI prompts. Customize every detail in seconds and export high-quality videos that captivate your audience.
                  </p>
                </div>
                <div className="flex flex-col sm:flex-row gap-4 pt-2">
                  <Link
                    href="/templates"
                    className="inline-flex items-center justify-center px-8 py-4 text-lg font-semibold bg-primary-gradient text-primary-foreground rounded-xl shadow-lg shadow-primary/25"
                  >
                    Start Creating
                  </Link>
                </div>
