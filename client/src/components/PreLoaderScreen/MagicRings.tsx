...
// The subset of props actually read inside the animation loop.
type MagicRingsLiveProps = Required<Omit<MagicRingsProps, 'blur'>>;
...
export default function MagicRings({
    ...
    const propsRef = useRef<MagicRingsLiveProps | null>(null);
    ...
    return (
        <div
            ref={mountRef}
            className="magic-rings-container absolute inset-0"
            style={{
